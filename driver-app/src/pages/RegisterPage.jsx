...
export default function RegisterPage() {
  ...
  const [form, setForm] = useState({ username: '', password: '', confirm: '', make: '', model: '', plate: '' });
    ...
    <div className="page auth-page">
      <div className="animate-in auth-container">
        <div className="auth-header">
          ...
          <h1 style={{ marginBottom: '0.375rem' }}>Driver Application</h1>
          <p className="text-muted text-sm">Join the fleet and start earning</p>
        </div>
        ...
        <div className="card auth-card">
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="divider" style={{ margin: '0.5rem 0' }}>Vehicle Info</div>
            ...
            <div className="form-group">
              <label className="form-label" htmlFor="reg-plate">License Plate</label>
              <input
                id="reg-plate"
                className="input"
            ...
            <button id="btn-register" type="submit" className="btn btn-primary btn-full mt-1" disabled={loading}>
